...
function Feedback() {
  ...
  return (
    <> 
        ...
        <img src='./pp.webp' alt="" className='blob_a blob3  animated-bounce' />
    
            <h1 className='title'>Let's Work Together</h1>
            <div className='feedSection'>
                <div className='feedinfo'>
                 <p className="info">
  Hey! Join the <mark>CodoFusion</mark> squad and vibe with the coolest community out there!  
  Spot any <mark>glitches or bugs</mark>? Don’t sleep on it — drop your tea and help us glow up the site! ✨  
